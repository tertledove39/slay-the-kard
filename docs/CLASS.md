...
| `Store` : Control | Store.cs | 商店界面。CanvasLayer叠加于WorldMap上方。7张卡按稀有度加权随机生成，价格按稀有度生成（`CardRestoration.StorePriceTable`：普通 10±3、稀有 20±5、史诗 40±6、传奇 60±8，下限 1），随机打折；待购卡复用手牌式金色边框、放大、置顶和上移反馈。点击购买→扣物资点→ChooseSomeCard选1张替换。refresh消耗5物资点重新生成7张卡。 |

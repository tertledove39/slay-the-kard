...
public partial class Bullet : Control
{
    ...
    async public Task Fly(cardBase_ from,cardBase_ to,double duration = 0.3)
    {
        ...
        Rotation = (to.GlobalPosition - from.GlobalPosition).Normalized().AngleTo(new Vector2(1, 0));
        GlobalPosition = from.GlobalPosition+offset;
        this.Visible = true;
        _currentTween = CreateTween();
        _currentTween.TweenProperty(this, "position", to.GlobalPosition+offset, duration)

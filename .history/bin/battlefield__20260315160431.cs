...
public class Player
{
    ...
    // 布局参数（可调）
    private float handSpacing = 140f;       // 卡牌间距
    private float hoverRaise = 60f;         // 悬停时抬起高度
    private float hoverSidePush = 35f;      // 悬停时其他卡向两侧让开的距离
...
/// </summary>
    ...
    public void RefreshMyHand()
    {
        ...
        float left = initPos.X - (cardsInHand.Count - 1) * handSpacing;
        for (int i = 0; i < cardsInHand.Count; i++)
        {
            ...
            // 悬停时高亮 / 缩放
            cardsInHand[i].SetHover(i == hoveredHandIndex, hoverScale);

...
/// </summary> 
    ...
    async public Task DiscardCard()
    {
        ...
        PivotOffset = new Vector2(90, 120);
        
        // 获取屏幕参数
        Vector2 screenSize = GetViewportRect().Size;
        Vector2 screenCenterY = new Vector2(0, screenSize.Y / 2);
        
        // 计算左侧屏幕中间位置（以锚点左上角计算）
        Vector2 leftEdgePos = new Vector2(-100, screenSize.Y / 2 - 120); // Y轴偏移120使卡牌中心在屏幕中间
        Vector2 leftScreenPos = new Vector2(100, screenSize.Y / 2 - 120);  // 屏幕左侧中间
        ...
        // 步骤3: 旋转着向左侧飞出 (1.5秒)
        Vector2 exitPosition = new Vector2(-400, screenSize.Y / 2 - 120); // 飞出到左侧

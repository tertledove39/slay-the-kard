...
/// </summary> 
    ...
    private async void FlashAttributeWithColor(string attributeName, int currentValue, int initialValue, int extremeValue, bool isInverted = false)
    {
        ...
        {
              // 切换到目标颜色
            tween.TweenProperty(targetLabel, "theme_override_colors/font_color", targetColor, 0.15f);
              // 切换回原始颜色
            tween.TweenProperty(targetLabel, "theme_override_colors/font_color", originalColor, 0.15f);
        }

...
/// </summary>
    ...
    private void CreateChoiceOverlay()
    {
        ...
        choiceContainer.AddConstantOverride("separation", 30);
    ...
    private async Task<cardBase_> ShowCardChoice(List<cardBase_> cards)
    {
        ...
        foreach (var card in choiceCards)
        {
            ...
            cardNode.SizeFlagsHorizontal = SizeFlags.ExpandFill;
            cardNode.SizeFlagsVertical = SizeFlags.ExpandFill;
        ...
        foreach (var segment in effectSegments)
        {
            ...
            for (int i = 0; i < parts.Length; i++)
            {
                ...
                if (instruction.StartsWith("Develop"))
                {
                    ...
                    {
                        // 显示选择界面
                        var selectedCard = await ShowCardChoice(randomCards);

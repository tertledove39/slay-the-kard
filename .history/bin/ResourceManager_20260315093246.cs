...
public partial class ResourceManager : Node
{
    ...
    public async Task InitializeAsync()
    {
        ...
        await PreloadTexturesAsync(toPreload);

        // 预加载卡牌场景
        await PreloadSceneAsync(CardScenePath);

        // 预加载空卡池
        await EnsureEmptyCardPoolAsync(DefaultEmptyCardPoolSize);
    ...
    public cardBase_ AcquireEmptyCard()
    {
        ...
        _ = EnsureEmptyCardPoolAsync(DefaultEmptyCardPoolSize);
        if (newCard != null)
        {
    ...
    public void ReleaseEmptyCard(cardBase_ card)
    {
        ...
        if (emptyCardPool.Count < DefaultEmptyCardPoolSize)
        {
            _ = EnsureEmptyCardPoolAsync(DefaultEmptyCardPoolSize);
        }
    }

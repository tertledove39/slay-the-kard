...
/// <returns></returns>
    ...
    private void SetupHoverHighlight()
    {
        ...
        if (hoverHighlight == null)
        {
            ...
            hoverHighlight.SetAnchorsAndMarginsPreset(Control.LayoutPreset.FullRect);
            hoverHighlight.SizeFlagsHorizontal = Control.SizeFlags.Fill;
            hoverHighlight.SizeFlagsVertical = Control.SizeFlags.Fill;

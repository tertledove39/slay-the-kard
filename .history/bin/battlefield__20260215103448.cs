...
/// 暂时用作测试
/// </summary>
    public async Task OnNextTurnButtonPressed()
    {
        _ = player1.DrawCard();
        await AddCardToPlace(new cardBase_().SetCardInformation(cardMaganer.GetCard("moscow")),GetPlaceWithPosition(new Vector2(500, 500)));
